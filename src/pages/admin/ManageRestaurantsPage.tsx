  ...
  return (
    <div className="min-h-screen pt-20 lg:pt-24 bg-slate-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        >
          <div>
            <h1 className="text-3xl font-bold text-slate-dark">Manage Restaurants</h1>
            <p className="text-slate-500 mt-1">Add, edit, or remove restaurants and dishes</p>
          </div>
        ...
        <div className="bg-white rounded-3xl shadow-lg shadow-slate-100 p-12 text-center">
          <p className="text-slate-500">Restaurant management interface</p>
        </div>
      </div>
    </div>
  );
